# Feature Matrix
> Platform: 1ai-nexus | Positioning: Bloomberg-grade Multi-Asset Intelligence | Updated: 2026-06-30
> Target: Indonesian trading desks, VCs, family offices | Price: 2B IDR/year (~$125K)

## Legend
✅ Done | 🚧 Partial | ❌ Missing | ⭐ Best-in-class | 🔍 Not researched

## Competitor Registry
| ID | Name | URL | Price/yr | Type |
|----|------|-----|----------|------|
| C1 | Bloomberg Terminal | bloomberg.com | $24K | direct |
| C2 | TradingView | tradingview.com | $600 | direct |
| C3 | Refinitiv/LSEG | lseg.com | $22K | direct |
| C4 | Koyfin | koyfin.com | $1.2K | direct |
| C5 | Nansen | nansen.ai | $1.8K | indirect |
| C6 | Trading Economics | tradingeconomics.com | $348 | indirect |
...
| Indonesian Gov Bonds (SUN) | ❌ | ✅ | ❌ | ✅ | ❌ | ❌ | ❌ | P1 |
| Cryptocurrencies | ⭐ | 🚧 | ✅ | 🚧 | ❌ | ⭐ | ✅ | — |
| Derivatives (Futures, Options) | ✅ | ⭐ | 🚧 | ⭐ | 🚧 | ❌ | ❌ | P1 |
...
| Feature | Ours | C1 | C2 | C3 | C4 | C5 | C6 | Priority |
|---------|:----:|:--:|:--:|:--:|:--:|:--:|:--:|----------|
| Portfolio Tracking | 🚧 | ⭐ | 🚧 | ⭐ | ✅ | ❌ | ❌ | P1 |
| P&L Attribution | ❌ | ⭐ | ❌ | ⭐ | ✅ | ❌ | ❌ | P1 |
| Risk Analytics (VaR, Sharpe) | ❌ | ⭐ | ❌ | ⭐ | ✅ | ❌ | ❌ | P1 |
| Position Sizing | ❌ | ⭐ | ❌ | ⭐ | 🚧 | ❌ | ❌ | P2 |
| Backtesting | ❌ | ⭐ | ✅ | ⭐ | 🚧 | ❌ | ❌ | P1 |

## On-Chain Intelligence (our moat)
| Feature | Ours | C1 | C2 | C3 | C4 | C5 | C6 | Priority |
|---------|:----:|:--:|:--:|:--:|:--:|:--:|:--:|----------|
| Wallet/Entity Labeling | ✅ | ❌ | ❌ | ❌ | ❌ | ⭐ | ❌ | — |
| Smart Money Tracking | ⭐ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | — |
| Token God Mode | 🚧 | ❌ | ❌ | ❌ | ❌ | ⭐ | ❌ | P1 |
| Whale Alerts (multi-chain) | ⭐ | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ | — |
| MEV Detection | ⭐ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | — |
| DEX Scanner (new pairs) | ⭐ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | — |
| DeFi Yield Farming | ⭐ | ❌ | ❌ | ❌ | ❌ | 🚧 | ❌ | — |
| Prediction Markets | ⭐ | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ | — |
